...
namespace MileStoneClient
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Create your own Message and copy to CommunicationoMessage
            CommunicationoMessage msg = new CommunicationoMessage(new Guid(), "Ben", timeUtc, "BenRh safd", "2");
            ...
            List<CommunicationoMessage> msgList = Communication.Instance.GetTenMessages("http://127.0.0.1:5452");
            Console.WriteLine("Reuest 10 Last Messages:");
            foreach (CommunicationoMessage msgItem in msgList)
            {
